...
while True:
    ...
    print("\n" + year_name[mem_list[0]-1] + class_name[mem_list[1]-1] + " " + day_name[mem_list[2]] + "曜日 " + str(mem_list[3]) + "時間目： " + str(sc_dict[str(mem_list[0]-1)][str(mem_list[1]-1)][str(mem_list[2])][str(mem_list[3]-1)]) + "\n")
